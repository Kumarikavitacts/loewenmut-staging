export const apiEndpoints ={
    homeEndpoint: `api/startseite?populate[Benefits][populate]=Icon&populate[Metadaten]=true&populate[Leistungen_Inhalt]=true&populate[Bildre_Text][populate][Button]=true&populate[Bildre_Text][populate][Bild]=true&populate[Bildre_Text][populate][Video]=true&populate[Bildre_Text][populate][Videominiatur]=true&populate[References][populate][referenzens][populate][Bild][populate]=*&populate[References][populate][referenzens][populate][Video][populate]=*&populate[References][populate][referenzens][populate][Videominiatur][populate]=*&populate[References][populate][Button]=true&populate[Arbeiten][populate]=*&populate[News][populate][news][populate][Bild][populate]=*&populate[Kontaktbereich]=true`,
