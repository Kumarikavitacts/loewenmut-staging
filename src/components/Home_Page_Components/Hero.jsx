...
const Hero = ({ assets, scrollToNext }) => {
    const heroData = useSelector((state) => state.home.data?.hero);
                ...
                <div className="container position-relative">
                    <div className="hero_row pb-0">
                        ...
                        <h1 className="text-center">
                            <span>{renderHtmlText(untertitel)}</span>
                            <div className="line" data-text={titel1}>{titel1}</div>
                            <div className="line line-2" data-text={titel2}>{titel2}</div>
                        </h1>
                ...
                <div className='container'>
                    ...
                    <div className="row feature_row mt-4 mt-lg-5">
                        ...
                        {benefits.map((benefit) => (
                            <div className="col-6 col-lg-3   feature-col text-center" key={benefit.id}>
                                {benefit.Icon?.url && (
                                   <>
                                    <SvgIcon
